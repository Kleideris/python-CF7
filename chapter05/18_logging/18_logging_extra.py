...
def configure_logger(log_file: str, logger_name: str) -> logging.Logger:
    ...
    Args:
        log_files (str): The name of the log file.
...
def search_item(items: List[Any], item_to_find: Any, logger: logging.Logger) -> int:
    ...
    Args:
        ...
        item_to_find: (Any): the items to find.
...
def main():
    ...
    # Configure logger
    my_logger = configure_logger(log_file, 'search-app2')

    employee_names = ["Alice", "Bob", "Charlie", "Hellen", "Diana"]
    # employee_to_find = "Chris"
    employee_to_find = "Charlie"
    # employee_to_find = None
    # employee_names = []


    try:
        index = search_item(employee_names, employee_to_find, my_logger)
